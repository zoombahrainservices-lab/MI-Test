...
export default function HomePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      {/* Hero Section */}
      <div 
        className="mb-12 sm:mb-16 px-4 py-16 sm:py-20 relative"
        style={{
          ...
          {isAuthenticated ? (
            <>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-2 sm:mb-3">
                Welcome back, <span className="text-blue-300">{user?.name || user?.email}</span>!
              </h1>
            ...
            <>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-2 sm:mb-3">
                Discover Your
                <span className="text-blue-300"> Multiple Intelligence</span>
              </h1>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-200 mb-4 sm:mb-6">
                Every mind is unique. Discover your strengths with Multiple Intelligence.
              </h2>
