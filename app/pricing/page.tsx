      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Choose the plan that's right for you. All plans include our comprehensive 
            Multiple Intelligence assessment and detailed results.
          </p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-gray-200">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-center">
                ...
                <span>Complete MI Assessment</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <li className="flex items-center">
                ...
                <span>Basic Career Suggestions</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span>1 Test Attempt</span>
              </li>
            </ul>
            
            <Link
              href="/"
              className="block w-full text-center bg-gray-600 hover:bg-gray-700 text-white font-bold py-3 px-6 rounded-lg transition duration-200"
            >
              Get Started Free
            </Link>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-xl p-8 border-2 border-blue-500 relative">
            ...
            <ul className="space-y-4 mb-8">
              ...
              <li className="flex items-center">
                ...
                <span>Detailed Development Plans</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <Link
              href="/signup"
              className="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition duration-200"
            >
              Start Premium Trial
            </Link>
          </div>
