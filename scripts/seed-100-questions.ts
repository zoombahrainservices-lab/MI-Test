...
async function seedQuestions() {
  console.log('🌱 Seeding Supabase with 100 questions...')
  ...
  try {
    ...
    console.log('📝 Inserting 100 questions...')
    ...
    console.log(`✅ Successfully seeded ${data?.length || questions.length} questions`)
