...
async function testCompleteFlow() {
  try {
    console.log('🧪 Testing complete flow end-to-end...');
    ...
    // 3. Simulate complete assessment flow
    console.log('\n3. Simulating complete assessment flow...');
    ...
    console.log(`✅ Has non-zero results: ${hasNonZeroResults}`);
    
    if (!hasNonZeroResults) {
      console.log('❌ All results are 0% - assessment calculation failed');
      return;
    }
    ...
    const enhancedResults = {
      ...
      quotientScores: [
        ...
        },
        {
          ...
          percentage: Math.round(((sortedResults.find(r => r.category === 'interpersonal')?.percentage || 0) + 
                                 (sortedResults.find(r => r.category === 'intrapersonal')?.percentage || 0)) / 2),
    ...
    console.log('📋 Summary:');
    console.log('✅ Questions loading: Working');
