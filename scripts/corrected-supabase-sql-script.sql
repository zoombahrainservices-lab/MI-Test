-- Corrected Supabase SQL Script with ALL 100 Unique Questions
...
-- Step 3: Insert all 100 unique questions in shuffled order
...
(65, 'Ensuring that every detail is correct before completing a task is important to me', 'Logical-Mathematical', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
...
(70, 'I often find ways to improve methods that are already considered efficient', 'Logical-Mathematical', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
...
(73, 'When given feedback, I focus on the details to understand how to improve', 'Logical-Mathematical', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
...
(82, 'My work environment is organized, and everything has a specific place', 'Logical-Mathematical', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
...
(86, 'I feel a strong sense of responsibility to correct inaccuracies for the benefit of others', 'Intrapersonal', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(87, 'Being seen as successful by my peers is an important motivator for me', 'Intrapersonal', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(88, 'I actively create and pursue new goals once current ones are achieved', 'Intrapersonal', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(89, 'Being appreciated for my contributions is important to me', 'Intrapersonal', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(90, 'Setting and achieving goals is a fundamental part of how I define success', 'Intrapersonal', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(91, 'I value a calm and tranquil environment where conflicts are minimal', 'Intrapersonal', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(92, 'I thrive in environments that allow me freedom and the ability to choose', 'Intrapersonal', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(93, 'New ideas and projects excite me more than the implementation or follow-through', 'Musical & Creative', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(94, 'Exploring and experiencing the world is a top priority for me', 'Naturalistic', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(95, 'Protecting those I care about is just as important as standing up for myself', 'Interpersonal', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(96, 'Injustice or unfairness prompts me to action; I must speak up', 'Existential/Spiritual', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(97, 'I strive to maintain harmony in my relationships and environment', 'Interpersonal', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(98, 'I often see multiple sides of an issue and try to mediate disagreements', 'Interpersonal', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(99, 'Avoiding tension and conflict is often more comfortable for me than addressing problems', 'Interpersonal', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true),
(100, 'Peaceful resolutions are more important to me than winning an argument', 'Interpersonal', 'easy', '["Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"]', true);
...
-- Step 6: Show first 10 questions to verify
