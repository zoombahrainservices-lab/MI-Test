...
-- This script fixes all database schema issues
...
-- 2. Add missing columns to test_results table
...
WHERE results IS NULL OR enhanced_results IS NULL OR answers IS NULL;
