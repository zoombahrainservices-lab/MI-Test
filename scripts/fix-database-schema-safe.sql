-- Safe database schema fix that handles existing policies
-- Run this in your Supabase SQL Editor

-- 1. Add missing columns to test_results table (ignore if they exist)
...
-- 2. Create question_responses table if it doesn't exist
...
-- 3. Create indexes (ignore if they exist)
...
-- 5. Drop existing policies if they exist, then create new ones
...
SELECT 'test_results columns:' as info;
